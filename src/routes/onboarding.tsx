...
const SLIDES = [
  {
    img: tech,
    kicker: "Step 01",
    title: "Expert HVACR service",
    body: "Heating, ventilation, air conditioning, piping, electrical, boilers — installs, repairs, and preventive care.",
  },
  {
    img: service,
    kicker: "Step 02",
    title: "Book in minutes",
    body: "Pick a service, choose a time that works, and get a confirmed appointment with a certified technician.",
  },
  {
    img: comfort,
    kicker: "Step 03",
    title: "Residential to government",
    body: "We serve homes, commercial sites, institutions, and government facilities — one reliable team.",
  },
];
    ...
    <div className="min-h-screen w-full flex justify-center bg-background">
      <div className="relative w-full max-w-[440px] min-h-screen bg-black overflow-hidden">
        ...
        <div className="relative z-10 flex flex-col justify-end min-h-screen p-6 pb-10">
          ...
          <h1 className="text-[32px] leading-[1.1] font-bold text-foreground max-w-[340px]">
            {slide.title}
          </h1>
